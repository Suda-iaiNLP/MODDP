...
class VideoProcessor:
    ...
    def __init__(self, video_root, num_frm=2, frm_sampling_strategy="rand", max_img_size=384, video_fmt='.mp4'):
        '''
    ...
    def _load_video_from_path_decord(self, video_path, height=None, width=None, start_time=None, end_time=None, fps=-1):
        try:
            ...
            vlen = len(vr) - 100 if len(vr) - 100 > 0 else len(vr)  # 防止帧数溢出  因为视频编码可能有误
